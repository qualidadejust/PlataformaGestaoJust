...
INSERT INTO "new_insumos" ("ativo", "ca", "categoria", "created_at", "descricao", "fornecedor_id", "id", "nome", "unidade", "updated_at", "validade_dias") SELECT "ativo", "ca", "categoria", "created_at", "descricao", "fornecedor_id", "id", "nome", "unidade", "updated_at", "validade_dias" FROM "insumos";
DROP TABLE "insumos";
