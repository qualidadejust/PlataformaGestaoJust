...
/**
 * Logo oficial da Construtora JUST.
 * Artes em `public/logos/`:
 *   logo-just.png        (marinho — fundos claros)
 *   logo-just-white.png  (branco — header / fundos escuros)
 * Sem o arquivo, cai num wordmark de texto on-brand.
 */
