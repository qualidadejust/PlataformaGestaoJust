// Contexto de autenticação da Plataforma JUST (compartilhado entre os fronts).
// Login centralizado no Core, alcançado via /core/api/auth (o interceptor api-base.ts cuida
// do prefixo do gateway em produção e injeta o token nas demais chamadas).
...
interface AuthCtx {
  ...
  /** true se o usuário tem a permissão (admin sempre tem). */
