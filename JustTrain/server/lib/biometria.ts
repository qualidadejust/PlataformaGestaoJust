// Verificação biométrica do JustTrain (igual ao JustSecurity). Os TEMPLATES vêm do
// JustCore (cadastro é lá, junto do colaborador); o match roda no serviço SourceAFIS
// (.NET, 4002). Usado para assinar a presença por digital (1:1 contra o cadastro).
